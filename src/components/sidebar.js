...
const SideBar = () => {
  ...
  <div className="sidebar-container">
    ...
    <menu className="sidebar-menu">
      ...
      <li className="menu-items"><Link to="/" className="menu-links" activeClassName="active">Investigators</Link></li>
      <li className="menu-items"><Link to="/scenarios" className="menu-links" activeClassName="active">Scenarios</Link></li>
    ...
    <div className="btn-group">
      ...
      <Link to="/" className="mob-menu-items" activeClassName="active"><button className="navbtn">Investigators</button></Link>
      <Link to="/scenarios" className="mob-menu-items" activeClassName="active"><button className="navbtn">Scenarios</button></Link>
